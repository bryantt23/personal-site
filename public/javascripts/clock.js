$(document).ready(function() {
  ...
  (function() {
    ...
    function(json) {
      ...
      clockDisplay(newDate, json.city);
    }
  );
  ...
  function clockDisplay(city, newDate) {
    ...
    $('#Date').html(city + dayNames[newDate.getDay()] + " " + newDate.getDate() + ' ' + monthNames[newDate.getMonth()] + ' ' + newDate.getFullYear());
